...
export default function Appsettings() {
  ...
  const handleEdit = (id) => {
    ...
    setEdit(true);
    axios
      .get(`${baseUrl}/appsetting/fetch-single/${id}`)
      .then((resp) => {
              ...
              >
                ...
                <Box>
                  <TextField
                    ...
                    size="small"
                  />
                  {Formik.touched.appsetting_name &&
                ...
                <Box>
                  <TextField
                    ...
                    size="small"
                  />
                  {Formik.touched.appsetting_code &&

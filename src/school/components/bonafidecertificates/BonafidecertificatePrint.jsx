...
export default function BonafidecertificatePrint() {
  ...
  useEffect(() => {
    const fetchPrintBonafidecertificate = async () => {
      try {
        const bonafidecertificatePrintResponse = await axios.get(
          `${baseUrl}/bonafidecertificate/fetch-print/${id}`,
          { params: { id: id } },
        );
        console.log(
          "bonafidecertificatePrintResponse",
          bonafidecertificatePrintResponse.data.data,
        );
        ...
        <View style={{ marginTop: 10, lineHeight: 1.6 }}>
          <Text>
            ...
            <Text style={{ fontWeight: "bold" }}>
              ...
              {printBonafidecertificate.year + 1}
            </Text>
            .
          </Text>
  ...
  return (
    <div className="flex-1 w-full">
      ...
      <div className="mt-6 flex justify-center gap-3">
        <PDFDownloadLink
          document={<PrintPDF />}
          fileName="bonafidecertificate.pdf"
        >

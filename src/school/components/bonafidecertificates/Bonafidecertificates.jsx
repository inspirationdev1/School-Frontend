...
export default function Bonafidecertificates() {
  ...
  const [printId, setPrintId] = useState(null);
    ...
    const handleEdit = (id) => {
        ...
        setEdit(true);
        axios.get(`${baseUrl}/bonafidecertificate/fetch-single/${id}`)
            .then((resp) => {
                Formik.setFieldValue("bonafidecertificate_name", resp.data.data.bonafidecertificate_name);
                Formik.setFieldValue("bonafidecertificate_code", resp.data.data.bonafidecertificate_code);
    ...
    const handlePrint = async (id) => {
        ...
        window.open(`/school/BonafidecertificatePrint?id=${id}`,
            '_blank');
        setPrint(false);
    ...
    const Formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            if (isEdit) {
                ...
                axios
                    .patch(`${baseUrl}/bonafidecertificate/update/${editId}`, {
                        ...values,
                    })
                    .then((resp) => {
                ...
                axios
                    .post(`${baseUrl}/bonafidecertificate/create`, { ...values })
                    .then((resp) => {
            ...
            <Box>
                ...
                <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
                    ...
                    >
                        ...
                        <Tab label={isEdit ? "Edit Bonafidecertificate" : "Add New Bonafidecertificate"} />
                        <Tab label="View List" />
                    </Tabs>
                </Box>
                    ...
                    <Box>
                        <Paper sx={{ p: 3, m: 2 }}>
                            ...
                            >
                                ...
                                {/* Bonafidecertificate Name */}
                                <Box>
                                    <TextField
                                        fullWidth
                                        label="Bonafidecertificate Name"
                                        ...
                                        size="small"
                                    />
                                    {Formik.touched.bonafidecertificate_name && Formik.errors.bonafidecertificate_name && (
                                        <p style={{ color: "red" }}>
                                ...
                                {/* Bonafidecertificate Code */}
                                <Box>
                                    <TextField
                                        disabled={isEdit}
                                        fullWidth
                                        label="Bonafidecertificate Code"
                                        ...
                                        size="small"
                                    />
                                    {Formik.touched.bonafidecertificate_code && Formik.errors.bonafidecertificate_code && (
                                        <p style={{ color: "red" }}>
                    ...
                    <Box>
                        <TableContainer component={Paper}>
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow>
                                        <TableCell component="th" scope="row"> bonafidecertificate Name</TableCell>
                                ...
                                <TableBody>
                                    {bonafidecertificates.map((value, i) => (
                                        <TableRow
                                            key={i}
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{value.bonafidecertificate_code}</TableCell>

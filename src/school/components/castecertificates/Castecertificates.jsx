...
export default function Castecertificates() {
  ...
  const filteredCastecertificates = castecertificates.filter((value) => {
    ...
    return (
      value.castecertificate_name?.toLowerCase().includes(searchText) ||
      value.castecertificate_code?.toLowerCase().includes(searchText) ||
  ...
  const handleEdit = (id) => {
    ...
    setEdit(true);
    axios
      .get(`${baseUrl}/castecertificate/fetch-single/${id}`)
      .then((resp) => {
        Formik.setFieldValue(
          "castecertificate_name",
          resp.data.data.castecertificate_name,
        );
        Formik.setFieldValue(
          "castecertificate_code",
          resp.data.data.castecertificate_code,
        );
        ...
        Formik.setFieldValue(
          "castecategory",
          resp.data.data?.generalmaster?._id,
        );
  ...
  const handlePrint = async (id) => {
    ...
    window.open(`/school/CastecertificatePrint?id=${id}`, "_blank");
    setPrint(false);
  };
      ...
      <Box>
        <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
          ...
          >
            ...
            <Tab
              label={
                isEdit ? "Edit Castecertificate" : "Add New Castecertificate"
              }
            />
            <Tab label="View List" />
          </Tabs>
              ...
              >
                ...
                <Box>
                  <TextField
                    ...
                    size="small"
                  />
                  {Formik.touched.castecertificate_name &&
                ...
                <Box>
                  <TextField
                    ...
                    size="small"
                  />
                  {Formik.touched.castecertificate_code &&
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        fullWidth
                        error={
                          Formik.touched.castecategory &&
                          Boolean(Formik.errors.castecategory)
                        }
                        helperText={
                          Formik.touched.castecategory &&
                          Formik.errors.castecategory
                        }
                      />
                    )}
                  />
          ...
          <Box>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableBody>
                  {filteredCastecertificates.length > 0 ? (
                    filteredCastecertificates.map((value) => (
                      <TableRow
                        key={value._id}
                        sx={{

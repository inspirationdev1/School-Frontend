...
export default function Examinations() {
    ...
    const handleEdit = (id) => {
        ...
        setEdit(true);
        axios.get(`${baseUrl}/examination/single/${id}`)
            .then((resp) => {
    ...
    const Formik = useFormik({
        ...
        onSubmit: (values) => {
            if (isEdit) {
                ...
                axios
                    .post(`${baseUrl}/examination/new`, { ...values })
                    .then((resp) => {
                ...
                <Box component={"div"} sx={{}}>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            {Formik.touched.examination_name && Formik.errors.examination_name && (
                            ...
                            <TextField
                                ...
                                onBlur={Formik.handleBlur}
                            />
                            {Formik.touched.examination_code && Formik.errors.examination_code && (
                                <p style={{ color: "red", textTransform: "capitalize" }}>

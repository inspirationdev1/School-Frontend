...
export default function MarksheetPrint() {
  ...
  useEffect(() => {
    const fetchPrintMarksheet = async () => {
      try {
        const marksheetPrintResponse = await axios.get(
          `${baseUrl}/marksheet/fetch-print/${id}`,
          { params: { id: id } },
        );
  ...
  const PrintPDF = () => (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* 🔷 Title */}
        <Text style={styles.reportTitle}>MARKSHEET</Text>
        ...
        <View>
          ...
          <View style={styles.rowStyle}>
            ...
            <Text style={styles.valueStyle}>{printMarksheet.teacher.name}</Text>
          ...
          <View style={styles.rowStyle}>
            ...
            <Text style={styles.valueStyle}>{printMarksheet.status}</Text>
            <Text style={styles.labelStyle}>Remarks :</Text>
            <Text style={styles.valueStyle}>{printMarksheet.remarks}</Text>
          </View>
        </View>
    ...
    <div className="flex-1 w-full">
      ...
      <div className="mt-6 flex justify-center gap-3">
        ...
        {/* <button
          ...
          onClick={downloadMarksheetExcel}
        >
          Download Excel
        </button> */}
      </div>

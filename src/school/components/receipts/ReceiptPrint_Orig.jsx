...
export default function ReceiptPrint_Orig() {
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View style={styles.spaceY}>
            <Text style={styles.textBold}>
              {printReceipt.school.school_name}
            </Text>
            <Text style={styles.textBold}>
              {printReceipt.school.address} - {printReceipt.school.city}
            </Text>
            <Text style={styles.textBold}>
              {printReceipt.school.state} - {printReceipt.school.country}
            </Text>
          </View>
        </View>
        ...
        <View>
          ...
          <View style={styles.rowStyle}>
            ...
            <Text style={styles.valueStyle}>{printReceipt.remarks}</Text>
          </View>
        </View>
        ...
        <Table style={styles.table}>
          ...
          <TR key={100}>
            ...
            <TD style={styles.td}>
              <Text style={styles.rightText}>
                {formatAmount(printReceipt.totalinvAmount)}
              </Text>
            </TD>

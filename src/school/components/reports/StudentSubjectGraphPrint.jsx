...
export default function StudentSubjectGraphPrint() {
    ...
    try {
      ...
      if (dataParam) {
        ...
        if (data?.year) {
          ...
          paramsRpt.year_name = data?.year_name;
        }

        paramsRpt.requesttype = "PDF";

        const response = await axios.post(
          `${baseUrl}/schoolreports/student-subject-graph-print`,
          ...
          <div className="mt-6 flex justify-center gap-3">
            <button
              onClick={() => {
                ...
                link.href = pdfUrl;
                link.download = "StudentSubjectPercentage.pdf";
                link.click();
              }}

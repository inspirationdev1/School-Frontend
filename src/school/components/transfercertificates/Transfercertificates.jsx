...
export default function Transfercertificates() {
  ...
  const [printId, setPrintId] = useState(null);
    ...
    const handleEdit = (id) => {
        ...
        setEdit(true);
        axios.get(`${baseUrl}/transfercertificate/fetch-single/${id}`)
            .then((resp) => {
                Formik.setFieldValue("transfercertificate_name", resp.data.data.transfercertificate_name);
                Formik.setFieldValue("transfercertificate_code", resp.data.data.transfercertificate_code);
                ...
                Formik.setFieldValue(
                    "leaveDate",
                    resp.data.data.leaveDate ? dayjs(resp.data.data.leaveDate).format("YYYY-MM-DD") : ""
                );
    ...
    const handlePrint = async (id) => {
        ...
        window.open(`/school/TransfercertificatePrint?id=${id}`,
            '_blank');
        setPrint(false);
            ...
            <Box>
                ...
                <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
                    ...
                    >
                        ...
                        <Tab label={isEdit ? "Edit Transfercertificate" : "Add New Transfercertificate"} />
                        <Tab label="View List" />
                    </Tabs>
                </Box>
                            ...
                            >
                                ...
                                <Box>
                                    <TextField
                                        ...
                                        size="small"
                                    />
                                    {Formik.touched.transfercertificate_name && Formik.errors.transfercertificate_name && (
                                        <p style={{ color: "red" }}>
                                ...
                                <Box>
                                    <TextField
                                        ...
                                        size="small"
                                    />
                                    {Formik.touched.transfercertificate_code && Formik.errors.transfercertificate_code && (
                                        <p style={{ color: "red" }}>
                    ...
                    <Box>
                        <TableContainer component={Paper}>
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                <TableHead>
                                    <TableRow>
                                        <TableCell component="th" scope="row"> transfercertificate Name</TableCell>
                                ...
                                <TableBody>
                                    {transfercertificates.map((value, i) => (
                                        <TableRow
                                            key={i}
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{value.transfercertificate_code}</TableCell>

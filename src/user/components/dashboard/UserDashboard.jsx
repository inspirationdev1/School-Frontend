  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Paper sx={{maxWidth:'780px', margin:"auto",padding:"10px", marginTop:"120px"}} >
       ...
       >
         <Typography sx={{ marginRight: "50px" }} variant="h4"> User Pic </Typography>
         ...
         >
          Cancel
             ...
             <Typography variant="h4" gutterBottom>
               User-Dashboard {userDetails && `[ ${userDetails.name} ]`}
             </Typography>
      ...
      {userDetails && (
        ...
        >
          ...
          <IconButton sx={{background:'white'}} onClick={handleUserEdit} color="primary">
            <EditIcon />
          </IconButton>
          </Box>
        </Box>

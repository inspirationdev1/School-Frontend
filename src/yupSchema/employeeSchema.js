...
export const employeeSchema = yup.object({
    ...
    employee_name: yup.string().min(4, "Name must contain 4 characters").required("Name is required"),
    employee_code: yup.string().min(4, "Code must contain 4 characters").required("Code is required"),
